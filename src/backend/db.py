...
class Document(Base):
    """Document record preserving file-level provenance and IngestReport."""
...
def get_session_factory():
    ...
    if _session_factory is None:
        _session_factory = sessionmaker(autocommit=False, autoflush=False, bind=get_db_engine())
    ...
    if target_engine.dialect.name == "postgresql":
        with target_engine.connect() as conn:
            try:
                ...
                print(f"[init_db] pgvector extension: {e}")
            ...
            try:
                ...
                print(f"[init_db] HNSW vector index: {e}")
